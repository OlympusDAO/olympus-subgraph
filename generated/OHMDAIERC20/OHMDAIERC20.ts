...
export class OHMDAIERC20__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class OHMDAIERC20__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class OHMDAIERC20 extends ethereum.SmartContract {
  static bind(address: Address): OHMDAIERC20 {
    return new OHMDAIERC20("OHMDAIERC20", address);
  }
  ...
  burn(to: Address): OHMDAIERC20__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new OHMDAIERC20__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<OHMDAIERC20__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new OHMDAIERC20__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): OHMDAIERC20__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new OHMDAIERC20__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<OHMDAIERC20__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OHMDAIERC20__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
