...
export class LPBondDepository__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class LPBondDepository extends ethereum.SmartContract {
  static bind(address: Address): LPBondDepository {
    return new LPBondDepository("LPBondDepository", address);
  }
  ...
  bondInfo(param0: Address): LPBondDepository__bondInfoResult {
    ...
    return new LPBondDepository__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_bondInfo(
    param0: Address
  ): ethereum.CallResult<LPBondDepository__bondInfoResult> {
    let result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new LPBondDepository__bondInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
