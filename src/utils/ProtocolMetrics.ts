...
function getMV_RFV(transaction: Transaction): BigDecimal[]{
    ...
    let ohmethPair = UniswapV2Pair.bind(Address.fromString(UNI_OHMETH_PAIR))
    ...
    if(transaction.blockNumber.gt(BigInt.fromString(UNI_OHMETH_PAIR_BLOCK))){
